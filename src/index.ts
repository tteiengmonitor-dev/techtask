...
function getUser(request: Request): User | null {
...
const GAS_URL =
"https://script.google.com/macros/s/AKfycbzIUzPRTYpMJTOkBnG8AhiwBcaTAyjowSFiFfmxv-dQKhzJKn8HyyOqHhfs7ZDFnBWDDQ/exec"
...
const cookie =
`user=${encodeURIComponent(JSON.stringify(data))}; Path=/; HttpOnly`

const redirect =
data.role === "planner" ? "/planner" : "/tech"
